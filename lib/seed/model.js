...
function Model (attributes, options) {
  ...
  this.merge(attributes, { silent: true });
...
Model.prototype.set = function(path, value, opts) {
  ...
  if (this.schema && this.schema instanceof Schema) {
...
Model.prototype.save = function (opts, callback) {
  ...
  var success = function (data) {
    self.merge(data, { silent: (opts.silent || false) });
    self.id = data._id;
  ...
  if (store) {
    ...
    failure(new SeedError('No storage defined.', { code: 'ENOSTORE' }));
  }
};
