...
Hash.prototype.set = function (key, value, silent) {
  ...
  if (!silent) this.emit([ 'set', key ], value);
};
...
Hash.prototype.del = function (key, silent) {
  ...
  if (!silent) this.emit([ 'delete', key ]);
};
